...
namespace MovieConnections.Framework.Mvc.Route {
    /// <summary>
    ...
    public static class RouteCollectionExtensions {
        ...
        public static System.Web.Routing.Route MapRouteLowercase(this RouteCollection routes, string name, string url) {
            return MapRouteLowercase(routes, name, url, null, null, null);
        }

        /// <summary>
        /// Maps the specified URL route using a lowercase URL and sets default route values. 
        /// Does not change casing in the querystring, if any.
        /// </summary>
        /// <param name="routes">A collection of routes for the application.</param>
        /// <param name="name">The name of the route to map.</param>
        /// <param name="url">The URL pattern for the route.</param>
        ...
        /// <summary>
        /// Maps the specified URL route using a lowercase URL and sets the namespaces. 
        /// Does not change casing in the querystring, if any.
        /// </summary>
        /// <param name="routes">A collection of routes for the application.</param>
        /// <param name="name">The name of the route to map.</param>
        ...
        /// <summary>
        /// Maps the specified URL route using a lowercase URL and sets default route values and constraints. 
        /// Does not change casing in the querystring, if any.
        /// </summary>
        /// <param name="routes">A collection of routes for the application.</param>
        /// <param name="name">The name of the route to map.</param>
        ...
        /// <summary>
        /// Maps the specified URL route using a lowercase URL and sets default route values and namespaces. 
        /// Does not change casing in the querystring, if any.
        /// </summary>
        /// <param name="routes">A collection of routes for the application.</param>
        /// <param name="name">The name of the route to map.</param>
        ...
        /// <param name="namespaces">A set of namespaces for the application.</param>
        /// <returns>A reference to the mapped route.</returns>
        public static System.Web.Routing.Route MapRouteLowercase(this RouteCollection routes, string name,
