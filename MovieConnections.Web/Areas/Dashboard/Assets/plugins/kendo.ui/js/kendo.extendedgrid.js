...
(function ($) {
    ...
    var extendedGrid = kendo.ui.Grid.extend({
        ...
        init: function(element, options) {
            ...
            var createPermission = ($(element).attr('data-create') && !$(element).attr('data-show-createcolumn')) || false;
            var exportPermission = ($(element).data('export') && !$(element).data('show-exportcolumn')) || false;
            var editPermission = ($(element).attr('data-edit') && !$(element).attr('data-show-editcolumn')) || false;
            var deletePermission = ($(element).attr('data-delete') && !$(element).attr('data-show-deletecolumn')) || false;
